-- ===============================================================
-- 最終修正版: 整合性問題の修正スクリプト（正しいテーブル構造完全対応）
-- 実装日: 2025-09-14
-- 目的: transactions テーブルを使用した分納データ整合性問題の修正
-- ===============================================================
...
-- 分納金額の整合性修正（transactions テーブル使用）
DO $$
DECLARE
...
SELECT '分納金額整合性' as check_type, COUNT(*) as remaining_issues FROM inst_check;

-- 完了メッセージ
SELECT '✅ 全ての整合性問題とパフォーマンス関数の修正が完了しました（最終版）' as status, NOW() as completion_time;