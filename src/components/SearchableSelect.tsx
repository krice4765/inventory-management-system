...
export default function SearchableSelect({
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className={`
          absolute z-[9999] w-full mt-1 border rounded-md shadow-2xl max-h-64 overflow-hidden min-w-max
          ${darkMode 
              ...
              filteredOptions.map((option, index) => (
                <div
                  ...
                  className={`
                    ...
                    ${index < filteredOptions.length - 1 ? 'border-opacity-50' : 'border-opacity-0'}
                  `}
                >
