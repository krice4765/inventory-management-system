...
const CreateOutboundOrderModal: React.FC<CreateOutboundOrderModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl w-full max-h-[90vh] p-0 bg-white dark:bg-gray-900 shadow-2xl">
        <DialogHeader className="p-6 pb-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-800">
        ...
        <div className="bg-white dark:bg-gray-900 min-h-full">
          ...
          <div className="border-b border-gray-200 dark:border-gray-600">
            <div className="p-6">
              <h3 className="text-base font-medium text-gray-900 dark:text-gray-100 flex items-center mb-4">
              ...
              <div className="grid grid-cols-3 gap-6 mb-4">
                <div>
                  <Label htmlFor="customer_name" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">仕入先</Label>
                  <SearchableSelect
                    options={[
                ...
                <div>
                  <Label htmlFor="due_date" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">希望期日</Label>
                  <Input
                    id="due_date"
                    type="date"
                ...
                <div>
                  <Label htmlFor="notes" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">備考</Label>
                  <Input
                    id="notes"
              ...
              <div className="grid grid-cols-3 gap-6">
                <div>
                  <Label htmlFor="request_date" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">発注日</Label>
                  <Input
                    id="request_date"
                    type="date"
                ...
                <div>
                  <Label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">送料</Label>
                  <div className="flex items-center h-10 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700">
                    <span className="text-sm text-gray-600 dark:text-gray-400">¥</span>
                    <span className="ml-2 text-sm text-gray-900 dark:text-gray-100 font-medium">0</span>
                  </div>
                </div>
          ...
          <div className="border-b border-gray-200 dark:border-gray-600">
            <div className="p-6">
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
                {/* テーブルヘッダー */}
                <div className="grid grid-cols-12 gap-4 px-4 py-3 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 text-sm font-medium text-gray-700 dark:text-gray-300">
                  <div className="col-span-5">商品検索</div>
        ...
        {/* フッターボタン */}
        <div className="p-6 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-600 flex justify-between items-center">
          <Button
            onClick={handleClose}
            variant="outline"
            size="lg"
