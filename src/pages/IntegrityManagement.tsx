...
export const IntegrityManagement: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8"><div className="py-6">
      ...
      : 'text-gray-500 hover:text-gray-700 border-transparent hover:bg-gray-100' } flex items-center px-4 py-2 border-b-2 font-medium text-sm transition-colors`}
                  >
      ...
      {/* メインコンテンツ */}
      <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-8">{activeTab === 'dashboard' && (
        ...
        {activeTab === 'settings' && (
          <div className="space-y-6">
            ...
            {/* 将来の機能プレースホルダー */}
      <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-6"><div className="bg-white border border-gray-200 rounded-lg p-6">
